...
## 現在の精度（ウォークフォワード検証 2025-09 ~ 2026-02）
- **統合戦略 TOP1**: 81.1%（111日中90日正解）
- **値下がり予測 単独**: 80.2%（主力。ほぼ毎日DOWN方向が選択される）
- **上昇予測 単独**: 49.5%（ランダム以下。改善が今後の課題）
- **UP/DOWN独立 TOP-N**:
  - 上昇: TOP1=49.5%, TOP3=46.5%, TOP5=49.0%
  - 値下がり: TOP1=80.2%, TOP3=73.9%, TOP5=72.8%
- **注**: TRAIN_LOOKBACK_YEARS=3 設定により学習データが直近3年に絞られ、テスト開始が2025-09以降となった（旧設定時は2025-03〜、224日）
